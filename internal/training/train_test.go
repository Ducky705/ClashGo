...
func (m *MockDevice) Pinch(x1, y1, x2, y2, x3, y3, x4, y4, ms int) error { return nil }
func (m *MockDevice) ZoomOut() error                                           { return nil }
func (m *MockDevice) ZoomIn() error                                            { return nil }
func (m *MockDevice) KeyEvent(code int) error                                  { return nil }
func (m *MockDevice) Text(text string) error                                   { return nil }
