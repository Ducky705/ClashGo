    ...
    <div className="bg-white dark:bg-zinc-900 p-6 rounded-[3rem] border border-zinc-100/50 dark:border-zinc-800/50 shadow-premium dark:shadow-none flex flex-col items-center max-w-5xl mx-auto transition-all duration-500">
      ...
      <div className="w-full max-w-[860px] aspect-[860/732] bg-zinc-950 dark:bg-black rounded-[2.5rem] overflow-hidden border border-zinc-800 dark:border-zinc-900 shadow-premium-lg flex items-center justify-center relative group">
        {screenshot ? (
          ...
          <div className="text-zinc-600 font-mono text-[11px] flex flex-col items-center gap-6">
            <div className="w-20 h-20 rounded-full bg-zinc-900/50 dark:bg-zinc-800/20 flex items-center justify-center shadow-inner border border-zinc-800/50">
              <span className="material-symbols-outlined text-4xl animate-pulse text-zinc-700 dark:text-zinc-600">videocam_off</span>
            </div>
        ...
        <div className="absolute top-8 left-8 flex items-center gap-4 px-5 py-2 bg-black/60 backdrop-blur-2xl rounded-2xl border border-white/10 shadow-2xl">
           ...
           <span className="text-[11px] font-black text-white uppercase tracking-[0.3em]">Live View</span>
        </div>
      </div>

      <div className="mt-8 grid grid-cols-2 gap-12 w-full max-w-3xl">
        ...
        <div className="flex items-center gap-6 group">
          ...
          <div className="flex flex-col">
            <span className="text-[10px] font-black text-zinc-300 dark:text-zinc-700 uppercase tracking-[0.2em] mb-0.5">System Errors</span>
            <span className="text-2xl text-zinc-950 dark:text-white font-bold tracking-tight tabular-nums">{stats.adb_health.consecutive_fails} <span className="text-xs text-zinc-400 dark:text-zinc-500 font-medium ml-1">fails</span></span>
          </div>
        </div>
      </div>
